...
# Adapted from https://github.com/fangchangma/self-supervised-depth-completion/blob/master/dataloaders/transforms.py
# and DenseDepth https://github.com/ialhashim/DenseDepth
